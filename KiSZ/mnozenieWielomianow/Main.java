...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Wpisanie pierwszych podstawowych 9 wyrazów
		...
		//wygenerowanie wszystkich s³ów: S(j+8) = S(j) + S(j+2) + S(j+3) + S(j + 4)
		for(int j = 1; j < 248; j++){
		...
		//Wyœwietlenie warstw cyklotomicznych
		...
		//Wyliczenie wielomianów minimalnych
